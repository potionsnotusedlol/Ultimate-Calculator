...
namespace winrt::Home_Assistant_XAML::implementation
{
    ...
    struct __declspec(empty_bases) MainWindow_base : implements<D, Home_Assistant_XAML::MainWindow, composing, I...>,
        impl::require<D, winrt::Microsoft::UI::Xaml::IWindow>,
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        using base_type = MainWindow_base;
        using class_type = Home_Assistant_XAML::MainWindow;
        ...
        {
            return L"Home_Assistant_XAML.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::Home_Assistant_XAML::factory_implementation
{
    ...
    {
        using instance_type = Home_Assistant_XAML::MainWindow;
