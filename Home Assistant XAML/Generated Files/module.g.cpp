...
void* winrt_make_Home_Assistant_XAML_MainWindow();
...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"Home_Assistant_XAML.MainWindow"))
    {
        return winrt_make_Home_Assistant_XAML_MainWindow();
    }

    if (requal(name, L"Home_Assistant_XAML.XamlMetaDataProvider"))
    {
        return winrt_make_Home_Assistant_XAML_XamlMetaDataProvider();
    }
