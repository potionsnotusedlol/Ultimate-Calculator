...
namespace winrt::Home_Assistant_XAML::implementation
{
    ...
    struct XamlMetaDataProvider : public ::winrt::Home_Assistant_XAML::implementation::XamlMetaDataProvider_base<XamlMetaDataProvider>
    {
